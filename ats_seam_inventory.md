...
C1 — ats_production_governor.py; executable module containing ATSGovernorProduction, StreamingBiasMonitor, SafeguardVerifier, LegalEvidencePackager, DecisionFunctionInverter, AuditReportValidator, and BiasNeutralizationEngine. [OBSERVED]
...
LOCATION: ats_production_governor.py, StreamingBiasMonitor.ingest_decision. [OBSERVED]
...
LOCATION: ats_production_governor.py, StreamingBiasMonitor.__init__, ingest_decision, and analyze_batch. [OBSERVED]
...
LOCATION: ats_production_governor.py, StreamingBiasMonitor.analyze_batch and _compute_rejection_gap_by. [OBSERVED]
...
LOCATION: ats_production_governor.py, StreamingBiasMonitor.analyze_batch and _vowel_ratio. [OBSERVED]
...
LOCATION: ats_production_governor.py, ATSGovernorProduction.process_hiring_decision. [OBSERVED]
...
LOCATION: ats_production_governor.py, SafeguardVerifier.verify_geographic_blind_scoring, verify_name_anonymization, and verify_independent_validation. [OBSERVED]
...
LOCATION: ats_production_governor.py, ATSGovernorProduction.run_full_audit. [OBSERVED]
...
LOCATION: ats_threat_model.md schemas; ats_production_governor.py and ats_counter_system.py analyzer methods. [OBSERVED]
...
SIDE B: C1 / ats_production_governor.__main__ [OBSERVED]
...
LOCATION: ats_production_governor.py, module entry point. [OBSERVED]
