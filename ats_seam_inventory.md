...
C4 — synapsis_gsa_source.txt; text artifact containing Python source for SynapsisGSA and its component classes. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, SystemConfig and SynapsisGSA.__init__/process_candidate_ingress. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, AuditLogger. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, SkillOntology and JDRequirementExtractor. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, ResumeSubstanceValidator. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, DomainTranspiler.register_industry and transpile. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, TandemAlphaBetaBridge.evaluate. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, MasterGovernanceControl.route_mid_band; human-review destination is documented in package and integration materials. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, RealityAnchorGate.validate_synthetic_packet and GammaRedTeam. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, SynapsisGSA.process_candidate_ingress. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, SynapsisGSA._transparency_directive and process_candidate_ingress. [OBSERVED]
...
LOCATION: synapsis_gsa_source.txt, final module-entry block and run_red_blue_tests. [OBSERVED]
