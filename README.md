...
Version: 2.0
Status: Working demonstration with documented capability gaps — see
`ats_seam_inventory.md` (`[OBSERVED]` vs `[DOCUMENTED]` vs `[NO EVIDENCE]`)
and the two confirmed gaps noted under "Code" above. Not production-hardened.
